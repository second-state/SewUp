...
sourcesIndex["sewup"] = {"name":"","dirs":[{"name":"kv","dirs":[{"name":"traits","files":["key.rs","mod.rs","value.rs"]}],"files":["errors.rs","mod.rs"]},{"name":"runtimes","files":["handler.rs","mod.rs","test.rs","traits.rs"]},{"name":"types","files":["mod.rs","raw.rs","row.rs"]}],"files":["errors.rs","lib.rs","primitives.rs","utils.rs"]};
